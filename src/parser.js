...
function peg$parse(input, options) {
  ...
  const peg$e8 = peg$literalExpectation("null", false);
...
      return result;
   }
  function peg$f4(k, v) {    return k(v);  }
  function peg$f5() {    return true;  }
  function peg$f6() {    return false;  }
  function peg$f7() {    return null;  }
  function peg$f8(first, rest) {
      return [first, ...rest.map(r => r[3])];
   }
  function peg$f9(chars) {    return chars.map(c => typeof c === "string" ? c : c[1]).join("");  }
  function peg$f10(chars) {    return chars.map(c => typeof c === "string" ? c : c[1]).join("");  }
  function peg$f11(esc) {
      switch(esc){
        case 'n': return '\\n';
        case 't': return '\\t';
        case 'r': return '\\r';
...
     }
  ...
  function peg$f15() {    return parseFloat(text());  }
